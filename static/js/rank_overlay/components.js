...
export function createPilotCard(
  ...
  nodeContainer.style.transform = `0px`;
  ...
  pilotTag.className = `h-full w-full text-nowrap overflow-hidden flex bg-gradient-to-r from-[color:var(--glass)] from-0% via-[color:var(--glass-lite)] via-5% to-[color:var(--glass)] to-20%`;
