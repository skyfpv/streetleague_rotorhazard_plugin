...
class RHmanager():
    ...
    def update_plugin(self, args):
        ...
        try:
            ...
            log("Street League plugin updated successfully. Please restart RotorHazard to see the changes.")
            self._rhapi.ui.message_alert("Street League plugin updated successfully. Please restart RotorHazard to see the changes.")
